...
namespace KassuBot
{
    public class FileOperations
    {
        ...
        private string teamListFilePath = @"C:\Users\Waltteri\Documents\KassuBot_Repo\KassuBot\TeamList.xlsx";
        ...
        {
            InitSheet("Overwatch", ref teamCountOverwatch);
        }

        public void InitHearthstoneSheet()
        {
            InitSheet("Hearthstone", ref hearthstonePlayerCount);
        }

        public void InitCtrSheet()
        {
            InitSheet("CTR", ref ctrPlayerCount);
        }

        private void InitSheet(string sheetName, ref int count)
        {
