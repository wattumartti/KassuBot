...
namespace KassuBot
{
    public class Program
    {
        ...
        public static string imgurClient = string.Empty;
        public static string spotifyAuthToken = string.Empty;
        public static string excelFilePath = string.Empty;
        public static string spotifyUserName = string.Empty;
        ...
        public async Task MainAsync(string[] args)
        {
            ...
            imgurClient = cfgjson.ImgurClient;
            spotifyAuthToken = cfgjson.SpotifyAuthToken;
            excelFilePath = cfgjson.ExcelFilePath;
            spotifyUserName = cfgjson.SpotifyDiscordUser;
    ...
    public struct ConfigJson
    {
        ...
        [JsonProperty("imgurClient")]
        public string ImgurClient { get; private set; }

        [JsonProperty("excelFilePath")]
        public string ExcelFilePath { get; private set; }

        [JsonProperty("spotifyAuthToken")]
        public string SpotifyAuthToken { get; private set; }

        [JsonProperty("spotifyDiscordUser")]
        public string SpotifyDiscordUser { get; private set; }
    }
}
