...
namespace KassuBot
{
    class Commands
    {
        ...
        private const string spotifyUserName = "UserName";
        ...
        public async Task ShowCurrentTrack(CommandContext ctx)
        {
            ...
            DiscordUser spotifyUser = ctx.Guild.Members.First(x => x.Username == spotifyUserName);
        ...
        public async Task ShowSchedule(CommandContext ctx)
        {
            ...
            DiscordEmbedBuilder embed = new DiscordEmbedBuilder()
                ...
                .WithImageUrl("https://scontent-arn2-1.xx.fbcdn.net/v/t1.0-9/50614278_2685281434830379_4616004255856197632_n.jpg?_nc_cat=108&_nc_ht=scontent-arn2-1.xx&oh=a629569736e000ccebc94fcd1966d053&oe=5CE21FCF");
